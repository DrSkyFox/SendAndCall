package ru.studentsmanager.repository;

import ru.studentsmanager.ObjectIsNull;
import ru.studentsmanager.interfaces.DAOInterface;
import ru.studentsmanager.persists.Student;

import javax.persistence.EntityManagerFactory;
import java.util.List;

public class StudentRepository extends ARepository implements DAOInterface<Student> {
